#!/usr/bin/env node
import { transformAsync, transformFileAsync, transformFromAstAsync, parseAsync, loadOptions, loadPartialConfigAsync, resolvePlugin, resolvePreset, createConfigItem, } from "@babel/core";
...
await fs.writeFile("../../examples/todo/appfiles/index.js.map", minified.map, { encoding: "utf-8" });
